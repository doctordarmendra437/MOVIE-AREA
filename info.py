...
CHANNELS = [
    ...
    for ch in environ.get("CHANNELS", "-1002804180914").split()
]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1002804180914"))
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", "-1002804180914"))
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002804180914"))
...
FILES_DATABASE = environ.get("FILES_DATABASE", "mongodb+srv://riteshkumarsingh:iX9Eeca9iRTH3buu@cluster0.sqrcqji.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
COLLECTION_NAME = environ.get("COLLECTION_NAME", "jisshu")

# Other Channel's
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1002918425042"))
DELETE_CHANNELS = int(environ.get("DELETE_CHANNELS", "0"))
request_channel = environ.get("REQUEST_CHANNEL", "-1002918425042")
REQUEST_CHANNEL = (
    int(request_channel)
...
SHORTENER_API = environ.get("ef9e633750559cdcc7b4dc6e544b53370a5116f0")
...
SHORTENER_API3 = environ.get(
    "SHORTENER_API3", "ef9e633750559cdcc7b4dc6e544b53370a5116f0"
)
